...
public class TileColliderShadow2D : MonoBehaviour
{
    ...
    private void Start()
    {
        // https://github.com/SeksitSeeton/Auto-add-Shadow-Caster-2D-on-TileMap/blob/main/Assets/ShadowCaster2DTileMap.cs
        Generate();
    }
